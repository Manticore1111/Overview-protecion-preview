    ...
    <main className="grain min-h-screen px-6 py-8 sm:px-8 lg:px-12">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
        <header className="panel rounded-[2rem] px-6 py-8 sm:px-8 sm:py-9">
          <p className="text-sm uppercase tracking-[0.28em] text-[var(--accent)]">voorwaarden</p>
          <h1 className="display-font mt-3 text-4xl font-bold tracking-tight text-white sm:text-5xl">Algemene voorwaarden</h1>
        ...
        <section className="panel rounded-[2rem] p-7 text-sm leading-8 text-[#bdbdbd] sm:p-9">
          <div className="space-y-8">
            <div>
              <h2 className="display-font text-2xl font-bold text-white">1. Toepasselijkheid</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">2. Aanvraag en overeenkomst</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">3. Uitvoering van de dienst</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">4. Verantwoordelijkheden van de opdrachtgever</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">5. Prijs, facturatie en annulering</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">6. Aansprakelijkheid</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-white">7. Contact</h2>
