      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6">
        ...
        <section className="panel rounded-[2rem] p-7 text-sm leading-8 text-[#556374] sm:p-9">
          <div className="space-y-8">
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">1. Wie wij zijn</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">2. Welke gegevens wij verwerken</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">3. Waarvoor wij gegevens gebruiken</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">4. Bewaren en delen</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">5. Jouw rechten</h2>
            ...
            <div>
              <h2 className="display-font text-2xl font-bold text-[#102033]">6. Wijzigingen</h2>
